...
## Tinyxel Errors ##
UNKNOW_FILE = "File not found in the current directory."
TINYXEL_COLOR = "Tinyxel error: invalid color."
TINYXEL_ISIZE = "invalid screen size (64 <= size <= 512)."
...
#_root.iconbitmap(default='icon.ico')
_root.withdraw()
...
def set_icon(file): #
    ...
    try :
        _root.iconbitmap(default=file)
    except :
        GraphicsError(UNKNOW_FILE)
#

def set_event(on_key_press = None, on_key_release = None): #

    if on_key_press != None : _root.bind("<KeyPress>", on_key_press)
    if on_key_release != None : _root.bind("<KeyRelease>", on_key_release)
#
...
# Default values for various item configuration options. Only a #
# subset of keys may be present in the configuration dictionary #
# for a given item.                                             #

DEFAULT_CONFIG = {"fill" : "", "outline" : "black", "width" : "1", "arrow" : "none", "text" : "", "justify" : "left", "font" : ("Small Fonts", 12, "normal")}
...
class GraphicsObject:
    ...
    def __init__(self, options): #
        ...
        # which options are legal for this object #
        
        # When an object is drawn, canvas is set to the GraphWin (canvas) #
        # object where it is drawn and the id is the TK identifier of the #
        # drawn shape.                                                    #
    ...
    def _draw(self, canvas, options): #
        ...
        # draws appropriate figureon canvas with options
        # provided Returns Tk id of item drawn.

        return "" # must override in subclass
    #
